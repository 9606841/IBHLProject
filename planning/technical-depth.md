...
## Technical risk
Interactions between 'block' objects that are nested within one another or next to one another may cause difficulty in the UIX, so methods need to be created for the interactions of the objects.
